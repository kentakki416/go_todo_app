...
import (
	...
	"github.com/kentakki416/go_todo_app/testutil/fixture"
...
func TestJWTer_GetToken(t *testing.T) {
	...
	want, err := jwt.NewBuilder().
		...
		Issuer(`github.com/kentakki416/go_todo_app`).
	...
	req := httptest.NewRequest(http.MethodGet, `https://github.com/kentakki416`, nil)
